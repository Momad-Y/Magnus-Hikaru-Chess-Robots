"""
This module contains the AlphaZeroNet class, which is a neural network with the AlphaZero architecture.
...
class AlphaZeroNet(nn.Module):
    ...
    def __call__(self, x, valueTarget=None, policyTarget=None, policyMask=None):
        ...
        if self.training:
            ...
            policyTarget = policyTarget.view(policyTarget.shape[0]) # type: ignore
            ...
            policyMask = policyMask.view(policyMask.shape[0], -1) # type: ignore
