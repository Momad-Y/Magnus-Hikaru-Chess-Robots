...
# Removed: os.chdir(os.getcwd() + "\\Dobot") -- a Windows-only path separator
# executed at import time. It mutated the process working directory as a side
# effect, which is what the old cwd + "/.." hack in GUI.py was compensating for.
sys.path.insert(1, os.path.join(os.path.dirname(os.path.abspath(__file__)), "DLL"))
